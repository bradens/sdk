import {
  OnBarsUpdatedSubscriptionVariables, OnBarsUpdatedSubscription,
  OnLatestTokensSubscriptionVariables, OnLatestTokensSubscription,
  OnDetailedStatsUpdatedSubscriptionVariables, OnDetailedStatsUpdatedSubscription,
  OnSimulateTokenContractSubscriptionVariables, OnSimulateTokenContractSubscription,
  OnNftEventsCreatedSubscriptionVariables, OnNftEventsCreatedSubscription,
  OnEventsCreatedSubscriptionVariables, OnEventsCreatedSubscription,
  OnNftPoolEventsCreatedSubscriptionVariables, OnNftPoolEventsCreatedSubscription,
  OnEventLabelCreatedSubscriptionVariables, OnEventLabelCreatedSubscription,
  OnTokenLifecycleEventsCreatedSubscriptionVariables, OnTokenLifecycleEventsCreatedSubscription,
  OnNftAssetsCreatedSubscriptionVariables, OnNftAssetsCreatedSubscription,
  OnPriceUpdatedSubscriptionVariables, OnPriceUpdatedSubscription,
  OnPairMetadataUpdatedSubscriptionVariables, OnPairMetadataUpdatedSubscription,
  OnLatestPairUpdatedSubscriptionVariables, OnLatestPairUpdatedSubscription,
  OnTokenEventsCreatedSubscriptionVariables, OnTokenEventsCreatedSubscription
...
export class Subscribe {
  ...
  onBarsUpdated = async (vars: OnBarsUpdatedSubscriptionVariables, sink: Sink<ExecutionResult<OnBarsUpdatedSubscription>>) => this.sdk.subscribe(`subscription OnBarsUpdated($pairId: String, $quoteToken: QuoteToken, $statsType: TokenPairStatisticsType) {
...
onLatestTokens = async (vars: OnLatestTokensSubscriptionVariables, sink: Sink<ExecutionResult<OnLatestTokensSubscription>>) => this.sdk.subscribe(`subscription OnLatestTokens($id: String, $networkId: Int, $tokenAddress: String) {
...
onDetailedStatsUpdated = async (vars: OnDetailedStatsUpdatedSubscriptionVariables, sink: Sink<ExecutionResult<OnDetailedStatsUpdatedSubscription>>) => this.sdk.subscribe(`subscription OnDetailedStatsUpdated($pairId: String, $statsType: TokenPairStatisticsType, $tokenOfInterest: TokenOfInterest) {
...
onSimulateTokenContract = async (vars: OnSimulateTokenContractSubscriptionVariables, sink: Sink<ExecutionResult<OnSimulateTokenContractSubscription>>) => this.sdk.subscribe(`subscription OnSimulateTokenContract($contractAddress: String, $networkId: Int!, $simulationId: String) {
...
onNftEventsCreated = async (vars: OnNftEventsCreatedSubscriptionVariables, sink: Sink<ExecutionResult<OnNftEventsCreatedSubscription>>) => this.sdk.subscribe(`subscription OnNftEventsCreated($address: String, $networkId: Int) {
...
onEventsCreated = async (vars: OnEventsCreatedSubscriptionVariables, sink: Sink<ExecutionResult<OnEventsCreatedSubscription>>) => this.sdk.subscribe(`subscription OnEventsCreated($address: String, $id: String, $quoteToken: QuoteToken) {
...
onNftPoolEventsCreated = async (vars: OnNftPoolEventsCreatedSubscriptionVariables, sink: Sink<ExecutionResult<OnNftPoolEventsCreatedSubscription>>) => this.sdk.subscribe(`subscription OnNftPoolEventsCreated($collectionAddress: String, $exchangeAddress: String, $networkId: Int, $poolAddress: String) {
...
onEventLabelCreated = async (vars: OnEventLabelCreatedSubscriptionVariables, sink: Sink<ExecutionResult<OnEventLabelCreatedSubscription>>) => this.sdk.subscribe(`subscription OnEventLabelCreated($id: String) {
  onEventLabelCreated (id: $id) {
    id, label, logIndex, networkId, timestamp, transactionHash, transactionIndex
  }
}`, vars, sink);
onTokenLifecycleEventsCreated = async (vars: OnTokenLifecycleEventsCreatedSubscriptionVariables, sink: Sink<ExecutionResult<OnTokenLifecycleEventsCreatedSubscription>>) => this.sdk.subscribe(`subscription OnTokenLifecycleEventsCreated($address: String, $networkId: Int) {
...
onNftAssetsCreated = async (vars: OnNftAssetsCreatedSubscriptionVariables, sink: Sink<ExecutionResult<OnNftAssetsCreatedSubscription>>) => this.sdk.subscribe(`subscription OnNftAssetsCreated($address: String, $networkId: Int, $tokenId: String) {
...
onPriceUpdated = async (vars: OnPriceUpdatedSubscriptionVariables, sink: Sink<ExecutionResult<OnPriceUpdatedSubscription>>) => this.sdk.subscribe(`subscription OnPriceUpdated($address: String, $networkId: Int) {
  onPriceUpdated (address: $address, networkId: $networkId) {
    address, confidence, networkId, priceUsd, timestamp
  }
}`, vars, sink);
onPairMetadataUpdated = async (vars: OnPairMetadataUpdatedSubscriptionVariables, sink: Sink<ExecutionResult<OnPairMetadataUpdatedSubscription>>) => this.sdk.subscribe(`subscription OnPairMetadataUpdated($id: String, $quoteToken: QuoteToken, $statsType: TokenPairStatisticsType) {
...
onLatestPairUpdated = async (vars: OnLatestPairUpdatedSubscriptionVariables, sink: Sink<ExecutionResult<OnLatestPairUpdatedSubscription>>) => this.sdk.subscribe(`subscription OnLatestPairUpdated($id: String, $networkId: Int) {
...
onTokenEventsCreated = async (vars: OnTokenEventsCreatedSubscriptionVariables, sink: Sink<ExecutionResult<OnTokenEventsCreatedSubscription>>) => this.sdk.subscribe(`subscription OnTokenEventsCreated($input: OnTokenEventsCreatedInput!) {
